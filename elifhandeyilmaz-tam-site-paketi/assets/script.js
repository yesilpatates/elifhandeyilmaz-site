(() => {
  ...
  const loadEditorialProjects = () => {
    addStylesheet("editorial-projects-styles", "assets/editorial-projects.css?v=20260827-issue58-v1");
    ...
    editorialScript.src = "assets/editorial-projects.js?v=20260827-issue58-v1";
